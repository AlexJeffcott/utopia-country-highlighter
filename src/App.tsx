...
//       <main>
//         <h2>Select a continent and click on the countries you want to highlight.</h2>
//         <div role="tablist" aria-label="Continent Picker Tabs" className="continent-picker">
//           {Object.keys(continentCountryMap).sort().map((continent, index) => (
//             <button
//               key={continent}
//               id={continent}
//               role="tab"
//               aria-selected={selectedcontinent === continent}
//               aria-controls={continent}
//               tabIndex={index}
